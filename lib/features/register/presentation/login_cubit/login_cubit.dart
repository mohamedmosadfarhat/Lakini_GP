...
class AppLoginCubit extends Cubit<AppLoginState> {
  ...
  void userReconfirm({
    ...
    DioHelper.postData(content: "application/json", url: "$Reconfirm/$email", data: {
      "email ": email,
    }).then((value) {
  ...
  void userforgotPassword({
    ...
    DioHelper.postData(content: "application/json", url: "$ForgotPassword/$email", data: {
      "email ": email,
    }).then((value) {
